...
class CSV2POST_Infoallprojectshistory_View extends CSV2POST_View {
    ...
    protected $view_name = 'infoallprojectshistory';
    ...
    */
    public function viewintroduction() {
        ...
        $intro = __( 'Still a very new feature. This displays a log of
        activity for all projects and is intended to act as the main
        method to ensure everything is running smoothly and at the 
        pace required for your websites community. It is also intended
        to act as a method to re-trace user steps and undo any negative changes.', 'csv2post' );
    ...
    */
    public function datatables( $data, $box ) { 
        ...
        // TODO 2 -o Ryan Bayne -c Data: get history stored in a .txt file (yet to be implemented).
        $query_results = array();
                     
        $WPTableObject = new CSV2POST_Allprojectshistory_Table();
...
class CSV2POST_Allprojectshistory_Table extends WP_List_Table {
