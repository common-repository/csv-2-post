 ...
 * @since 8.1.3
 */
class CSV2POST_Infosources_View extends CSV2POST_View {
    ...
    protected $view_name = 'infosources';
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( $this->view_name . '-datasources', __( 'Sources Table', 'csv2post' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'datasources' ), true, 'activate_plugins' )
        );    
    }
    ...
    * @version 1.1
    */
    public function postbox_infosources_datasources( $data, $box ) {    
        ...
        $SourcesTable = new CSV2POST_ProjectDataSources_Table();
