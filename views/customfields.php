...
class CSV2POST_Customfields_View extends CSV2POST_View {
    ...
    */
    public function viewintroduction() {
        ...
        $intro = __( 'Custom fields (post meta) is where things really start to come
        together, especially for the latest themes which rely on them
        heavily. My plugin will add meta to all of your posts and it will
        be just as if you added it yourself when looking at the Custom Fields
        list. More advanced processes are available including templates which
        make use of multiple values in your data to build one larger value.', 'csv2post' );
    ...
    */
    public function postbox_customfields_customfieldstable( $data, $box ) {    
        ...
        $CFTable = new CSV2POST_CustomFields_Table();
...
class CSV2POST_CustomFields_Table extends WP_List_Table {
