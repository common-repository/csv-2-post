...
class CSV2POST_Infoprojectsdata_View extends CSV2POST_View {
    ...
    protected $view_name = 'infoprojectsdata';
    ...
    */
    public function viewintroduction() {
        ...
        $intro = __( 'This table show some of the data you have imported
        for the current active projects. The Applied column shows you when
        the row was used to create or update a post. The Times Altered column
        can be used to confirm automatic updating is working well. Please note that
        many automated features are provided in the premium edition.', 'csv2post' );
    ...
    * @version 1.1
    */
    public function postbox_infoprojectsdata_datatable( $data, $box ) { 
    ...
    public function datatables( $data, $box ) {
        ...
        foreach( $sourceid_array as $key => $source_id){
            ...
            $ReceivingTable = new CSV2POST_ImportTableInformation_Table();
...
class CSV2POST_ImportTableInformation_Table extends WP_List_Table {
