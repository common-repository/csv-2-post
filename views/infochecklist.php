...
class CSV2POST_Infochecklist_View extends CSV2POST_View {
    ...
    protected $view_name = 'infochecklist';
    ...
    */
    public function viewintroduction() {
        ...
        $intro = __( 'Use this checklist to remind yourself what options
        you still need to use. Many of the items in this list are advanced
        and offered in the premium edition. For a chance to win a copy of
        the premium edition you can follow the project on Twitter or Facebook. 
        Go to the WebTechGlobal.co.uk website if you wish to purchase and download today.', 'csv2post' );
        ...
        $this->UI->intro_box_dismissible( 'infochecklist-introduction', $main_title, $intro, $info_area = true, $title, $info, $foot );               
    }
