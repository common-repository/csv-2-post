...
class CSV2POST_Dates_View extends CSV2POST_View {
    ...
    */
    public function viewintroduction() {
        ...
        $intro = __( 'Setup dates using data or generate them to suit
        your website or WordPress theme. Various approaches are possible
        and most if not all are provided free due to it being such a key
        element of posts.', 'csv2post' );
