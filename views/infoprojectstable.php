...
class CSV2POST_Infoprojectstable_View extends CSV2POST_View {
    ...
    protected $view_name = 'infoprojectstable';
    ...
    */
    public function viewintroduction() {
        $main_title = __( 'Projects Table Introduction', 'csv2post' );
    ...
    */
    public function datatables( $data, $box ) { 
        global $wpdb, $csv2post_settings, $CSV2POST_Class;
        
        $query_results = array();

        $query_results = $CSV2POST_Class->get_projects();
          
        $WPTableObject = new CSV2POST_Tableofprojects_Table();
...
class CSV2POST_Tableofprojects_Table extends WP_List_Table {
    ...
    function column_default( $item, $column_name ){
        ...
        switch( $column_name ){
            ...
            case 'tablename':
                ...
                return CSV2POST_DBTrait::get_project_main_table( $item['projectid'] ); 
    ...
    function get_columns() {
        $columns = array(
            ...
            'status' => __( 'Status', 'csv2post' ),       
            'timestamp' => __( 'Timestamp', 'csv2post' ),       
            'source1' => __( 'Source ID 1', 'csv2post' ),            
            'tablename' => __( 'Database Table', 'csv2post' ),            
