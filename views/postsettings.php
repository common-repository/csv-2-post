...
class CSV2POST_Postsettings_View extends CSV2POST_View {
    ...
    */
    public function viewintroduction() {
        $main_title = __( 'Post Settings Explained', 'csv2post' );
        
        $intro = __( 'All the most common and familiar options are on 
        this view. The important thing to remember is that selections 
        here will not change your WordPress core settings. Selections 
        here will only apply to posts created by CSV 2 POST.', 'csv2post' );
        ...
        $this->UI->intro_box_dismissible( 'postsettings-introduction', $main_title, $intro, $info_area = true, $title, $info, $foot );               
    }
