...
class CSV2POST_Infodirectorysources_View extends CSV2POST_View {
    ...
    * @version 1.1
    */
    public function postbox_infodirectorysources_datasourcestable( $data, $box ) { 
    ...
    */
    public function datatables( $data, $box ) { 
        ...
        $WPTableObject = new CSV2POST_Directorysources_Table();
...
class CSV2POST_Directorysources_Table extends WP_List_Table {
