 ...
 * @since 8.1.3
 */
class CSV2POST_Setupposts_View extends CSV2POST_View {
    ...
    protected $view_name = 'setupposts';
    ...
    */
    public function viewintroduction() {
        $main_title = __( 'Post Creation Explained', 'csv2post' );
        
        $intro = __( 'Create and Update posts here. CSV 2 POST can update posts after you use basic or
        advanced options but it is best to apply those options prior to
        creating posts. Please go to Basic or Advanced Options before
        creating all of your posts.', 'csv2post' );
    ...
    * @version 1.1
    */
    public function postbox_setupposts_createpostsbasic( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_updatepostsbasic( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_updatepostsbasicnewdataonly( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_updatepostsbasicprojectchangesonly( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_updatespecificpost( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_queryduplicateposts( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_refreshallposts( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_undoprojectposts( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_resetimportedrows( $data, $box ) {    
    ...
    * @version 1.1
    */
    public function postbox_setupposts_recreatemissingposts( $data, $box ) {    
    ...
    * @version 1.0
    */
    public function postbox_setupposts_masspublishposts( $data, $box ) {
