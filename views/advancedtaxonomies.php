 ...
 * @since 8.1.3
 */
class CSV2POST_Advancedtaxonomies_View extends CSV2POST_View {
    ...
    */
    public function viewintroduction() {
        $main_title = __( 'Taxonomies Introduction', 'csv2post' );
        $intro = __( 'Taxonomy features are now being re-developed and
        are always fully supported in the premium edition. The free edition
        will get standard support. Taxonomies can get complex and is an
        area that usually requires a lot of support from WebTechGlobal.', 'csv2post' );
        ...
        $this->UI->intro_box_dismissible( 'taxonomies-introduction', $main_title, $intro, $info_area = true, $title, $info, $foot );               
    }
