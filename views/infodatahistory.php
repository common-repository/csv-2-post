...
class CSV2POST_Infodatahistory_View extends CSV2POST_View {
    ...
    protected $view_name = 'infodatahistory';
    ...
    * @version 1.1
    */
    public function postbox_infodatahistory_datasourcestable( $data, $box ) { 
    ...
    */
    public function datatables( $data, $box ) { 
        ...
        $WPTableObject = new CSV2POST_Datahistory_Table();
...
class CSV2POST_Datahistory_Table extends WP_List_Table {
