...
class CSV2POST_Help {
    ...
    */
    public function get_help_array() {   
        ...
        // PAGES: betatest1
        $h[ 'betatest1' ][ 'pageinfo' ] = self::enterpage( 'Testers', 'Beta Testing: About testers area about text intro text help text etc', 'csv2post.wordpress.com', 'www.youtube.com', 'discussurl' );
