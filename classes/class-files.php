...
* @author Ryan Bayne 
*/                                                 
//class CSV2POST_Files extends CSV2POST { commented 14092014
class CSV2POST_Files { 
    ...
    */
    public function singlefile_uploader( $file_array, $uploads = false, $test_size = true, $test_type = false, $overwrite = false ) {              
        ...
        // There has been a situation where $file_array was null.
        if ( $file_array === null ) {
            $result_array['outcome'] = false;
            $result_array['error'] = true;
            $result_array['message'] = __( 'The single file uploader needed more information than was giving. No file was uploaded as a result.', 'csv2post' );
            return $result_array;            
        }        
